			...
			var rentInsurance2 = {
  				x: ['June', 'July', 'August', 'September', 'October', 'November', 
  					'December', 'January', 'February', 'March', 'April', 'May'],
  				y: [23.47,23.47,23.47,23.47,23.47,23.47,23.47,23.47,23.47,23.47,23.47,23.46],
  				name: "Renter's Insurance",
  				type: 'bar',
  				marker: {
  					color: 'A9E0F7'
			...
			var internet2 = {
  				x: ['June', 'July', 'August', 'September', 'October', 'November', 
  					'December', 'January', 'February', 'March', 'April', 'May'],
  				y: [50.94,50.94,50.94,50.94,50.94,50.94,50.94,50.86,50.94,50.94,50.94,50.94],
  				name: 'Internet',
  				type: 'bar',
  				marker: {
  					color: 'DBF978'
			...
			var getMonthDataYear2 = function(monthNumber, monthName, monthColor)
			{
				var month = {
						...
						x: [rent2['y'][monthNumber], rentInsurance2['y'][monthNumber], coned2['y'][monthNumber], 
							...
							travel2['y'][monthNumber], presents2['y'][monthNumber], miscellaneous2['y'][monthNumber], 
							totalPerMonth2['y'][monthNumber], projectedTotal2['y'][monthNumber]],
						y: ['Rent', 'Renter Insurance', 'ConEd', 'Internet', 'Food Staples', 'Food Eating Out',
							'Travel', 'Presents', 'Miscellaneous', 'Total','Projected Total'],
						name: monthName + ' Spending',
						type: 'bar',
						orientation: 'h',
						marker:
